...
import '../../learning/data/lessons/questions/differential_calculus_questions.dart';
...
class MockQuestions {
  ...
  static List<QuizQuestion> getQuestions({
    ...
    switch (topic.toLowerCase()) {
      ...
      case 'calculus':
        questions = List<QuizQuestion>.from(DifferentialCalculusQuestions.allQuestions);
        break;
      case 'data structures':
      default:
        questions = List<QuizQuestion>.from(dataStructures);
        break;
    }
