import '../domain/models/flashcards_model.dart';
  ...
  static List<FlashcardModel> getCards(String deckId) {
    ...
    return [
      ...
      FlashcardModel(
        ...
        back: 'When two different keys produce the same hash index. Resolved via chaining (linked lists at each bucket) or open addressing.',
        topic: 'Data Structures',
      ),
      FlashcardModel(
        id: '7',
      ...
      FlashcardModel(
        ...
        back: 'A mathematical notation describing the upper bound of an algorithm\'s time or space complexity as input size grows — focuses on worst-case performance.',
        topic: 'Data Structures',
      ),
    ];
  }
