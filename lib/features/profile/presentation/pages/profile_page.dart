  ...
  Widget build(BuildContext context) {
    return StreamBuilder<Map<String, dynamic>?>(
      ...
      builder: (context, snapshot) {
        ...
        final isLoading = snapshot.connectionState == ConnectionState.waiting && profile == null;
          ...
          child: SlideTransition(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                if (!isLoading && !hasError) SliverToBoxAdapter(child: ProfileStatsRow(
                ...
                if (!isLoading && !hasError) SliverToBoxAdapter(child: _Section(title: 'Study activity', linkLabel: 'See history', onLink: () {}, child: const ActivityRingsCard())),
