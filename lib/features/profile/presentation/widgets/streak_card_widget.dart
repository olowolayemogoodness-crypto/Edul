    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          const Row(children: [
            _Dot('M', _S.done), SizedBox(width: 5),
            _Dot('T', _S.done), SizedBox(width: 5),
            _Dot('W', _S.done), SizedBox(width: 5),
            _Dot('T', _S.done), SizedBox(width: 5),
            _Dot('F', _S.done), SizedBox(width: 5),
            _Dot('S', _S.today), SizedBox(width: 5),
            _Dot('S', _S.next),
          ]),
        ])),
        Column(children: [
