...
class _CameraScanPageState extends State<CameraScanPage> {
  ...
  Future<void> _analyzeWithGemini(File imageFile) async {
    ...
    try {
      final text = '''QUESTION: Unable to analyze image content
EXPLANATION: Gemini API integration is not enabled in this build. Please configure your Gemini API key and restore the image analysis implementation.''';
