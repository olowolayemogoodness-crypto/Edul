    ...
    return Column(children: [
      ...
      Expanded(child: SingleChildScrollView(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Padding(
          ...
          child: answered
            ? GestureDetector(
                onTap: () { HapticFeedback.lightImpact(); setState(() { if (_qi < _questions.length - 1) {
                  _qi++;
                } else {
                  _go(_PracticeTab.results);
                } }); },
            ...
            : GestureDetector(
                onTap: () { HapticFeedback.selectionClick(); setState(() { _flagged[_qi] = true; if (_qi < _questions.length - 1) {
                  _qi++;
                } else {
                  _go(_PracticeTab.results);
                } }); },
