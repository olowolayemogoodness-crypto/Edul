  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        Row(children: [
          AnimatedBuilder(animation: _pulse, builder: (_, animation) =>
        ...
        const _RoomRow(emoji: '📐', name: 'WAEC Mathematics revision', sub: '14 students · Algebra & Trig',
          avatarColors: [AppColors.accentSurface, Color(0xFF0D2219), Color(0xFF2A1F00)],
          avatarLabels: ['AO','TF','+11'], actionLabel: 'Return →', actionColor: AppColors.success),
        const SizedBox(height: AppSpacing.sm),
        Container(height: 0.5, color: AppColors.border),
        const SizedBox(height: AppSpacing.sm),
        const _RoomRow(emoji: '🎙️', name: 'IELTS Speaking drills', sub: '7 students · recording on',
          avatarColors: [Color(0xFF0C1E32), AppColors.accentSurface, Color(0xFF2A1020)],
